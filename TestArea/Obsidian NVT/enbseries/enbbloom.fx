...
//-----------------------------------------------------------//
//            ENB-BLOOM-PROCESSING SHADER SUITE              //
//                                                           //
///////////////////////////////////////////////////////////////
...
float Empty_Row1 <
  string UIName="---------------------Day Settings-------------------";   string UIWidget="spinner";  float UIMin=0.0;  float UIMax=0.0;
> = {0.0};
...
float Empty_Row2 <
  string UIName="----------------------Night Settings-----------------";   string UIWidget="spinner";  float UIMin=0.0;  float UIMax=0.0;
> = {0.0};
...
float Empty_Row3 <
  string UIName="--------------------Interior Settings----------------";   string UIWidget="spinner";  float UIMin=0.0;  float UIMax=0.0;
> = {0.0};
...
float Empty_Row4 <
  string UIName="------------------Saturation Settings--------------";   string UIWidget="spinner";  float UIMin=0.0;  float UIMax=0.0;
> = {0.0};
...
technique11 MultiPassBloom <string UIName="NVT-Obsidian Preset"; string RenderTarget="RenderTarget1024";>
{
	pass p0
	{
		SetVertexShader(CompileShader(vs_5_0, VS_Quad()));
