...
int Vignette <string UIName="--------------------------VIGNETTE";  string UIWidget="spinner";  int UIMin=0;  int UIMax=0;> = {0};
  bool ENABLE_VIGNETTE < string UIName = "Enable Vignette"; > = {false};
    float EVignetteAmount < string UIName="Vignette: Amount";     string UIWidget="Spinner";  float UIMin=0.0; > = {1.0};
    float EVignetteCurve < string UIName="Vignette: Curve";       string UIWidget="Spinner";  float UIMin=0.0; > = {4.0};
    float EVignetteRadius < string UIName="Vignette: Radius";     string UIWidget="Spinner";  float UIMin=0.0; > = {1.4};
    float3 EVignetteColor < string UIName="Vignette: RGB Color";  string UIWidget="Color"; > = {0.0, 0.0, 0.0};
...
float4 msVignette(float4 color, float2 txcoord0) {
  if (ENABLE_VIGNETTE==true) {
    float3 origcolor = color;

      float2 uv      = (txcoord0.xy - 0.5f) * EVignetteRadius;
